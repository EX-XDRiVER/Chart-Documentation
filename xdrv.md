...
`DISABLE_LEADERBOARD_UPLOADING`, is a boolean that disables leaderboards if enabled. This is used for songs like Metronome. Currently, custom charts don't have leaderboards, so this is unused.
